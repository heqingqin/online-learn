...
export const constantRoutes = [
  ...
  // 首页
  {
    ...
    children: [{
      ...
      meta: { title: '我的学院后台首页', icon: 'dashboard' }
    }]
  }]
/**
 * 动态路由
...
export const asyncRoutes = [
  ...
  },
  {
    ...
    name: '贴片管理',
    meta: { title: '贴片管理', icon: 'example' },
    children: [
      {
        path: 'list',
        name: '贴片列表',
        component: () => import('@/views/front/banner/list'),
        meta: { title: '贴片列表', icon: 'table' }
      },
      {
        path: 'add',
        name: '添加贴片',
        component: () => import('@/views/front/banner/add'),
        meta: { title: '添加贴片', noCache: true },
        hidden: true
      }
    ]
  },
